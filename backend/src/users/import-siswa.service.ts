...
export class ImportSiswaService {
  ...
  async buildTemplate(): Promise<Buffer> {
    ...
    header.eachCell((cell) => {
      ...
      cell.fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FFD7263D' } };
      cell.alignment = { vertical: 'middle', horizontal: 'center' };
    });
    sheet.addRow([1, 'Contoh Nama Siswa', '260401999', 'X AKL 1', JURUSAN_VALID[0], new Date().getFullYear(), 'Laki-laki']);
    sheet.addRow([]);

...
export function LupaPasswordCard() {
  return (
    <motion.div
      ...
      className="relative z-10 flex w-full max-w-235 flex-col gap-3 rounded-[36px] bg-white p-4 shadow-[0_0_0_1px_rgba(251,146,60,0.18),0_4px_16px_rgba(234,88,12,0.08),0_20px_56px_rgba(234,88,12,0.12),0_40px_100px_rgba(249,115,22,0.07)] sm:flex-row-reverse sm:gap-4 sm:p-5"
    >
      <div

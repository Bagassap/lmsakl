...
export function LupaPasswordCard() {
  return (
    <motion.div
      ...
      className="relative z-10 flex w-full max-w-235 flex-col gap-3 rounded-[36px] bg-white p-4 shadow-[0_0_0_1px_rgba(234,88,12,0.18),0_4px_16px_rgba(234,88,12,0.08),0_20px_56px_rgba(234,88,12,0.12),0_40px_100px_rgba(234,88,12,0.07)] sm:flex-row-reverse sm:gap-4 sm:p-5"
    >
      <div
      ...
      >
        ...
        <div className="relative z-10 flex flex-row items-center gap-3 sm:flex-col sm:gap-0 sm:text-center">
          ...
          >
            <motion.div
              className="absolute h-24 w-24 rounded-full bg-[#EA580C]/35 blur-2xl sm:h-48 sm:w-48"
          ...
          <div className="relative z-10 sm:mt-8">
            ...
            <div className="mt-5 hidden sm:flex sm:justify-center">
              <span className="inline-flex items-center gap-2 rounded-full border border-white/18 bg-white/[0.07] px-3.5 py-1.5 text-[9.5px] font-medium uppercase tracking-[0.12em] text-white/75">
                <span className="h-1 w-1 shrink-0 rounded-full bg-[#EA580C]/70" />

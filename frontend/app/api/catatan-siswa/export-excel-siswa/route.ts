...
export async function GET(request: Request) {
  ...
  try {
    backendRes = await fetch(`${BACKEND}/api/catatan-siswa/export-excel-siswa?${qs}`, {
  ...
  headers.set("Content-Disposition", disposition ?? "attachment; filename=\"CatatanSiswa.xlsx\"");

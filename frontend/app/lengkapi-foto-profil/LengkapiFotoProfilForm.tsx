    ...
    <motion.div initial="hidden" animate="visible" variants={container} className="mt-6 flex flex-col gap-4">
      ...
      {!imageSrc ? (
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="group relative mx-auto mb-8 flex h-40 w-40 items-center justify-center rounded-full border-2 border-dashed border-[#F59E0B]/30 bg-[#F59E0B]/5 transition-colors hover:border-[#F59E0B]/55 hover:bg-[#F59E0B]/10 sm:h-44 sm:w-44"
        >
          <div className="flex flex-col items-center gap-2">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#F59E0B]/10 transition-colors group-hover:bg-[#F59E0B]/20">
              <ImagePlus size={22} className="text-[#F59E0B]" />
            </div>
        ...
        <motion.div variants={item} className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 px-1">
            ...
            <input
              ...
              className="h-1.5 w-full cursor-pointer appearance-none rounded-full bg-black/10 accent-[#F59E0B]"
            />
          </div>

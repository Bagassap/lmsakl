...
const INPUT_CLASS =
  "w-full rounded-xl border border-black/10 bg-black/3 px-3.5 py-2.5 text-sm text-black placeholder:text-black/35 outline-none transition-all focus:border-[#EA580C] focus:bg-white focus:ring-2 focus:ring-[#EA580C]/15";

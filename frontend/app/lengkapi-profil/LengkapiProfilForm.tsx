...
const INPUT_CLASS =
  "w-full rounded-xl border border-black/10 bg-black/3 px-3.5 py-2.5 text-sm text-black placeholder:text-black/35 outline-none transition-all focus:border-[#D7263D] focus:bg-white focus:ring-2 focus:ring-[#D7263D]/15";
    ...
    >
      ...
      <motion.div variants={item} className="rounded-2xl border border-black/8 bg-black/2 p-4">
        <div className="mb-3 flex items-center gap-2">
          <MapPin size={15} className="text-[#D7263D]" />

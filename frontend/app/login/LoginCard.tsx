...
export function LoginCard() {
  return (
    <motion.div
      ...
      className="relative z-10 grid w-full max-w-235 grid-cols-1 overflow-hidden rounded-tl-[20px] rounded-tr-[56px] rounded-bl-[56px] rounded-br-[20px] bg-white shadow-[0_0_0_1px_rgba(180,83,9,0.14),0_4px_16px_rgba(215,38,61,0.08),0_20px_56px_rgba(215,38,61,0.14),0_40px_100px_rgba(180,83,9,0.10)] md:grid-cols-[300px_1fr]"
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-row items-center gap-4 sm:flex-col sm:gap-0 sm:text-center">
          ...
          >
            <motion.div
              className="absolute h-20 w-20 rounded-full bg-[#E8677A]/30 blur-2xl sm:h-40 sm:w-40"
          ...
          <div className="relative z-10 sm:mt-7">
            <p className="hidden items-center justify-center gap-1.5 text-[9.5px] font-semibold uppercase tracking-[0.24em] text-[#F0A3AC]/70 sm:flex">
            ...
            <div className="mx-auto mt-4 hidden h-px w-16 sm:block bg-[linear-gradient(90deg,transparent,rgba(215,38,61,0.9),rgba(220,38,38,0.6),transparent)]" />

            <p className="mt-3 hidden text-[11.5px] font-light leading-relaxed text-[#FCF0F1]/60 sm:block">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-[300px] z-20 hidden w-4 -translate-x-1/2 md:block">
        <div className="mx-auto h-full w-px border-l-2 border-dashed border-[#5C1420]/15" />

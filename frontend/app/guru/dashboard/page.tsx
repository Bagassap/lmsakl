    ...
    <div className="relative isolate -m-4 overflow-hidden lg:hidden">
      ...
      <div className="rounded-3xl bg-white p-3 shadow-[0_10px_28px_-10px_rgba(215,38,61,0.35)] dark:bg-[#1c2434]">
        ...
        <div className="grid grid-cols-5 gap-1.5 pt-4">
          {[
            { href: "/guru/materi", label: "Materi", icon: BookOpen, color: "#D7263D" },
            { href: "/guru/data-siswa", label: "Data Siswa", icon: Users, color: "#C3F84A", dark: true },
            { href: "/guru/magang/penempatan", label: "PKL", icon: Briefcase, color: "#2962FF" },
            { href: "/guru/ujian-ukk/jadwal-soal", label: "UKK", icon: FileText, color: "#FF5722" },
            { href: "/guru/pengumuman", label: "Pengumuman", icon: Megaphone, color: "#5E0000", badge: data.pengumuman.length },
          ].map((s, i) => (

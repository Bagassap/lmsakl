            ...
            {pageItems.map((s, idx) => {
              ...
              return (
                <motion.div key={s.id}
                  ...
                  <Avatar src={s.user?.fotoProfil} nama={displayNama} sizePx={36} fallbackBg="#2962FF" textClassName="text-[10px] font-extrabold" />
          ...
          {pageItems.map((s) => {
            ...
            return (
              <div key={s.id} className="flex items-center gap-3 p-3">
                <Avatar src={s.user?.fotoProfil} nama={displayNama} sizePx={38} fallbackBg="#2962FF" textClassName="text-[10px] font-extrabold" />
                <div className="min-w-0 flex-1">
                  ...
                  {mustChange === null ? (
                    ...
                    <span className="mt-1 inline-flex w-fit items-center gap-1 rounded-lg bg-[#8B0000] px-2 py-0.5 text-[10px] font-semibold text-white">

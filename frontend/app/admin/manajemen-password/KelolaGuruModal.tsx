                  ...
                  {guruList.map((g) => {
                    ...
                    return (
                      <div key={g.id}
                        ...
                        <div className={`absolute inset-y-0 left-0 w-1 ${g.isActive ? "bg-[#2962FF]" : "bg-red-400"}`} />
                        ...
                        <div className="mt-2.5 flex flex-wrap items-center gap-1.5">
                          ...
                          {(g.guru?.mapelDiampu ?? []).map((m) => (
                            <span key={m.id} className="flex items-center gap-1 rounded-lg bg-primary-light/40 px-2.5 py-1 text-[11px] font-semibold text-primary dark:bg-primary/10 dark:text-red-300">
                              {m.nama}
                          ...
                          <span className="flex items-center gap-1">
                            <input
                              ...
                              className="w-28 rounded-lg border border-dashed border-slate-300 bg-transparent px-2.5 py-1 text-[11px] font-semibold text-slate-600 focus:outline-none focus:ring-1 focus:ring-primary dark:border-slate-600 dark:text-slate-300"
                            />
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-1.5">
                          ...
                          {(g.guru?.kelasWali.length ?? 0) === 0 ? (
                            ...
                            g.guru!.kelasWali.map((k) => (
                              <span key={k.id} className="rounded-lg bg-primary/10 px-2.5 py-1 text-[11px] font-semibold text-primary">
                                {k.nama}
                              </span>
                            ))
                          )}

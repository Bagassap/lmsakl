              ...
              <div className="mt-2 flex items-center gap-1.5">
                {r.user && (
                  <button onClick={() => onProcess(r)}
                    className="flex flex-1 items-center justify-center gap-1 rounded-lg bg-primary px-2 py-1.5 text-[11px] font-semibold text-white shadow-sm transition-all hover:brightness-95">

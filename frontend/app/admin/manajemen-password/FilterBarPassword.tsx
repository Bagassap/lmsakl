  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-slate-100 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800 sm:p-5">
      <div
        ...
        style={{ backgroundImage: "radial-gradient(circle, #D90429 1px, transparent 1px)", backgroundSize: "18px 18px" }}
      />
        ...
        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
          <div className="relative shrink-0 sm:w-44">
            ...
            <select
              ...
              className="h-10.5 w-full appearance-none rounded-lg border border-slate-200 bg-white pl-9 pr-8 text-sm font-semibold text-slate-700 transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/12 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
            >
        ...
        <div className="relative mt-4 flex items-center justify-between gap-2 rounded-2xl border border-violet-100 bg-violet-50/50 p-3 dark:border-violet-900/30 dark:bg-violet-900/10">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button onClick={onResetWali}
              className="flex items-center gap-1 rounded-lg bg-primary px-2.5 py-1.5 text-[11px] font-semibold text-white shadow-sm hover:brightness-95">

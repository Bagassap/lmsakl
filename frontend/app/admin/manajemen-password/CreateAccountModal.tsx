            ...
            <form onSubmit={handleSubmit} className="flex-1 space-y-4 overflow-y-auto p-6">
                    ...
                    return (
                      <button key={r.value} type="button" onClick={() => setRole(r.value)}
                        className={`flex flex-1 items-center justify-center gap-1.5 rounded-lg px-2 py-2.5 text-xs font-bold transition-all ${
                          active ? "bg-primary text-white shadow-sm" : "bg-gray-100 text-gray-500 hover:bg-gray-200 dark:bg-slate-700 dark:text-slate-400"
                        }`}>
              ...
              {role === "SISWA" ? (
                <>
                  ...
                  <p className="rounded-xl bg-primary-light/40 px-4 py-2.5 text-xs text-primary dark:bg-primary/10 dark:text-red-300">

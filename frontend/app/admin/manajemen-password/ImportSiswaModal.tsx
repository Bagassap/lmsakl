          ...
          <motion.div initial={{ opacity: 0, scale: 0.94, y: 16 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.94, y: 16 }}
            ...
            <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
              ...
              <button type="button" onClick={() => downloadTemplate(toast)}
                className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-200 px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:border-primary/30 hover:bg-primary-light/30 dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-800">
              ...
              <button onClick={submit} disabled={!file || uploading}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-bold text-white shadow-sm disabled:opacity-50">

    ...
    <>
      <div className="space-y-5 p-1">
        ...
        {selectedTahapan && (() => {
          ...
          const bg5 = onLime ? "bg-black/5" : "bg-white/5";
          ...
          return (
          <div className={`relative rounded-2xl overflow-hidden shadow-lg ${fg}`}
            ...
            <div className={`pointer-events-none absolute -bottom-8 right-32 h-36 w-36 rounded-full ${bg5}`}/>
            ...
            <div className="relative px-5 pt-5 pb-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex flex-col items-end gap-1">
                  <span className={`rounded-xl px-3 py-1 text-lg font-extrabold backdrop-blur-sm ${bg20}`}>
                    {hadirPct}%
                  </span>

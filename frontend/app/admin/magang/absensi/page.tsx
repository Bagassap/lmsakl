...
import { STATUS_CFG, PULANG_CFG, WALLET_GRADIENTS, WALLET_ON_LIME, WALLET_ON_TEXT, MONTH_NAMES, RANGE_MODE_CARDS, reportCardFg, todayJakarta, formatTgl, formatTglSlash, avatarColor } from "@/components/absensi-harian/shared";
    ...
    <>
      ...
      <div className="relative -m-4 lg:hidden" style={{ background: "#D7263D" }}>
        ...
        <div className="space-y-4 rounded-t-[28px] bg-surface p-4 dark:bg-[#1c2434]">
          ...
          <div className="flex items-center gap-2 rounded-3xl bg-white p-2.5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] dark:bg-[#1c2434]">
                  ...
                  {tempatList.map((t) => {
                    ...
                    return (
                      <button key={t.id} type="button"
                        ...
                        style={isSelected ? { background: "#F8D6DA" } : undefined}>
                        <div className="min-w-0">
                          <p className={`truncate text-sm font-bold ${isSelected ? "" : "text-slate-800 dark:text-slate-100"}`}
                            style={isSelected ? { color: "#D7263D" } : undefined}>{t.namaTempat}</p>
                        ...
                        <span className="shrink-0 rounded-lg px-2 py-1 text-xs font-bold"
                          style={{ color: isSelected ? "#D7263D" : "#64748B", background: isSelected ? "#F8D6DA" : "#F1F5F9" }}>
                          {s.pct}%
                        </span>
                      </button>
                    );

        ...
        <div className="rounded-3xl border border-slate-100 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="grid grid-cols-2 gap-3 lg:flex lg:flex-col lg:gap-4">
            <button type="button" onClick={() => setCategory("lapor-diri")}
              className="relative flex h-24 flex-col justify-between overflow-hidden rounded-xl bg-primary px-3 py-3 text-left text-white transition-all hover:scale-[1.01] active:scale-[0.99] sm:rounded-2xl lg:h-32 lg:px-5 lg:py-5"
              style={{
            ...
            <button type="button" onClick={() => setCategory("laporan")}
              ...
              <div className="pointer-events-none absolute -right-4 -top-4 h-16 w-16 rounded-full bg-black/10 lg:-right-6 lg:-top-6 lg:h-28 lg:w-28" />
              <div className="relative flex h-7 w-7 items-center justify-center rounded-xl bg-black/15 lg:h-9 lg:w-9 lg:rounded-2xl">
              ...
              <div className="relative min-w-0">
                ...
                <p className="mt-0.5 truncate text-[9px] font-medium text-black/75 sm:text-[10px] lg:text-[11px]">{menungguReview} menunggu review</p>
              </div>
            </button>
          </div>
        </div>

  ...
  return (
    <div className="space-y-5 lg:p-1">
        ...
        {loading ? (
          ...
          <div className="flex flex-col overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="grid grid-cols-1 gap-3 p-5 sm:grid-cols-2">
              ...
              <div className="flex items-start gap-2.5 rounded-2xl bg-slate-50 p-3.5 dark:bg-slate-700/30">
                <User size={15} className="mt-0.5 shrink-0 text-primary" />
                <div>
      ...
      <div className="relative isolate -m-4 lg:hidden" style={{ background: "#D7263D" }}>
        ...
        {loading ? (
          <div className="h-40 animate-pulse rounded-3xl bg-white dark:bg-[#1c2434]" />
        ) : !aktif ? (
          <div className="flex flex-col items-center justify-center gap-3 rounded-3xl bg-white px-6 py-14 text-center shadow-[0_2px_8px_rgba(0,0,0,0.06)] dark:bg-[#1c2434]">
          ...
          <div className="overflow-hidden rounded-3xl bg-primary shadow-[0_4px_16px_-6px_rgba(215,38,61,0.35)]">
            ...
            <div className="space-y-2 rounded-t-3xl bg-white p-4 dark:bg-[#1c2434]">
              <div className="flex items-start gap-2.5 rounded-2xl bg-slate-50 p-3.5 dark:bg-slate-700/30">
                <MapPin size={15} className="mt-0.5 shrink-0 text-primary" />
                <div className="min-w-0">

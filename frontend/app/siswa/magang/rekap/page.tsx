            ...
            <div className="flex flex-col gap-4">
              ...
              <button type="button" onClick={() => setCategory("laporan")}
                ...
                <div className="relative min-w-0">
                  ...
                  <p className="mt-0.5 truncate text-[11px] font-medium text-black/75">{loading ? "…" : laporanAkhirSubtitle}</p>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="relative -mx-4 -mt-4 lg:hidden" style={{ background: "#D7263D" }}>
            ...
            <div className="isolate flex gap-1.5 rounded-2xl bg-slate-100 p-1.5 dark:bg-slate-800/60">
              <button type="button" onClick={() => setCategory("lapor-diri")}
                ...
                {category === "lapor-diri" && (
                  <motion.span layoutId="rekapPklTabPill" className="absolute inset-0 rounded-xl bg-primary"
              ...
              <button type="button" onClick={() => setCategory("laporan")}
                className="relative flex flex-1 items-center justify-center gap-1.5 rounded-xl py-3 text-sm font-bold transition-colors"
                style={{ color: category === "laporan" ? "#000" : "#94a3b8" }}>
                {category === "laporan" && (

  ...
  return (
    <div className="space-y-5">
      ...
      <div className="hidden lg:grid lg:grid-cols-2 lg:gap-3">
        ...
        <div className="flex items-center gap-2.5 rounded-2xl border border-slate-100 bg-white p-3 dark:border-slate-700/50 dark:bg-slate-800">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#F7E8E8] text-sm font-black text-[#750000] dark:bg-[#300000]/30 dark:text-[#A62E2E]">
            ±
          </span>
          <div className="leading-tight">
            ...
            {data.catatan.map((c) => (
              <div key={c.id} className="p-5">
                <div className="mb-1.5 flex items-start justify-between gap-2">
                  ...
                  {c.poin != null && (
                    <span className="shrink-0 rounded-lg bg-[#F7E8E8] px-2.5 py-1 text-[11px] font-bold text-[#750000] dark:bg-[#300000]/30 dark:text-[#A62E2E]">{c.poin} poin</span>
                  )}
                </div>
      ...
      <div className="relative -m-4 lg:hidden" style={{ background: "#D7263D" }}>
        ...
        <div className="space-y-3 rounded-[28px] bg-white p-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] dark:bg-[#1c2434]">
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center gap-2.5 rounded-2xl bg-primary p-4">
            ...
            <div className="flex items-center gap-2.5 rounded-2xl p-4" style={{ background: "#750000" }}>
          ...
          <div className="overflow-hidden rounded-2xl bg-surface dark:bg-slate-900/30">
            {loading && (
            ...
            {!loading && data && data.catatan.length > 0 && (
              <div className="divide-y divide-white dark:divide-slate-700/40">
                {data.catatan.map((c) => {
                  const accent = c.poin != null ? "#750000" : "#D7263D";
                  return (

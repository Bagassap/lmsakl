...
export function MateriTugasAdminPage() {
  ...
  async function resetPercobaan(submisiId: string) {
    ...
    if (res.ok) {
      toast.success("Percobaan direset!");
      loadAll();
    } else {
      toast.error("Gagal mereset percobaan");
    }
  }
      ...
      <div className="grid grid-cols-1 items-start gap-4 sm:gap-6 lg:grid-cols-[1fr_2.3fr]">
        <div>
          <div className="hidden rounded-3xl border border-slate-100 bg-white p-8 shadow-lg dark:border-slate-700 dark:bg-slate-800 lg:block">
            ...
            <div className="flex flex-col gap-4">
              <button type="button" onClick={() => setCategory("materi")}
                ...
                style={{
                  boxShadow: category === "materi" ? "0 8px 24px rgba(215,38,61,0.35)" : "0 8px 24px rgba(0,0,0,0.15)",
                  outline: category === "materi" ? "2px solid #D7263D" : "none",
                  outlineOffset: "3px",
                }}>
              ...
              <button type="button" onClick={() => setCategory("tugas")}
                ...
                <div className="relative min-w-0">
                  ...
                  <p className="mt-0.5 truncate text-[11px] font-medium text-black/75">
          ...
          <div className="relative -mx-4 -mt-4 lg:hidden" style={{ background: "#D7263D" }}>
            ...
            <div className="rounded-t-[28px] bg-surface px-4 py-3 dark:bg-[#1c2434]">
            <div className="space-y-3 rounded-3xl bg-white p-3 shadow-[0_2px_8px_rgba(0,0,0,0.06)] dark:bg-[#1c2434]">
              ...
              <div className="isolate flex gap-1.5 rounded-2xl bg-slate-100 p-1.5 dark:bg-slate-800/60">
                <button type="button" onClick={() => setCategory("materi")}
                  ...
                  {category === "materi" && (
                    <motion.span layoutId="materiTugasAdminTabPill" className="absolute inset-0 rounded-xl bg-primary"

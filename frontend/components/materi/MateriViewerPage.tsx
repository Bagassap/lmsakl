...
export function MateriViewerPage({ materiId, backHref }: { materiId: string; backHref: string }) {
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 z-[9999] flex flex-col bg-slate-50 dark:bg-slate-900">
        {TopBar}
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        {!fileUrl ? (
          ...
          <div className="flex min-h-full flex-col items-center justify-center gap-4 p-14 text-center">
            ...
            <a href={fileUrl} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-bold text-white shadow-md">

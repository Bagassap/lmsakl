...
export function ExportButtons({ tempatMagangId, tempatNama, range, siswaList }: {
  ...
  const PDF_STYLE = { backgroundColor: "#FCF0F1", color: "#D32F2F", borderColor: "#D32F2F30" };
  const EXCEL_STYLE = { backgroundColor: "#ECFCCB", color: "#4D7C0F", borderColor: "#C3F84A30" };
      ...
      <AnimatePresence>
        {picker && (
          <SiswaPickerModal
            ...
            accent={picker === "pdf" ? "#D32F2F" : "#C3F84A"}

    ...
    <>
      <div className="flex-1 overflow-x-auto">
        <div className="min-w-225">
          <div className="grid items-center gap-3 px-5 py-3" style={{ gridTemplateColumns: GRID_COLS, backgroundColor: "#000000" }}>
            <span />
            <span />
                  ...
                  <div className="flex justify-center">
                    {ttdRaw ? (
                      <button onClick={openDokumen} title="Lihat tanda tangan"
                        className="flex h-6 w-6 items-center justify-center rounded-lg hover:bg-[#D7263D] dark:hover:bg-[#D7263D]/20">
                        <PenTool size={13} className="text-[#D7263D]" />
                      </button>

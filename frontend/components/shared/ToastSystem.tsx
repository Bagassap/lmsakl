...
const THEME = {
  ...
  error: {
    ...
    iconBg:      "linear-gradient(135deg,#991B1B,#EF4444,#FCA5A5)",
    iconShadow:  "0 16px 40px rgba(239,68,68,0.55)",
    bar:         "linear-gradient(90deg,#991B1B,#FCA5A5)",
  ...
  info: {
    ...
    iconBg:      "linear-gradient(135deg,#1D4ED8,#2563EB,#93C5FD)",
    iconShadow:  "0 16px 40px rgba(37,99,235,0.55)",
    bar:         "linear-gradient(90deg,#1D4ED8,#93C5FD)",

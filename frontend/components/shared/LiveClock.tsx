...
export function LiveClock({ variant = "header" }: { variant?: "header" | "compact" }) {
  ...
  if (variant === "compact") {
    return (
      <div className="flex items-center gap-2 rounded-xl bg-white/12 px-3 py-1.5 backdrop-blur-sm">
        <Clock size={11} className="shrink-0 animate-pulse text-[#D7263D]" />
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur-sm dark:border-white/10 dark:bg-white/5 sm:gap-3 sm:px-4 sm:py-2">
      <div className="flex items-center gap-1.5 sm:gap-2">
        <CalendarDays className="h-3 w-3 shrink-0 text-[#D7263D] sm:h-4 sm:w-4" />
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        <Clock className="h-3 w-3 shrink-0 animate-pulse text-[#D7263D] sm:h-4 sm:w-4" />

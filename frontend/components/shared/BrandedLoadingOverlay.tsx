  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: "rgba(158,27,46,0.28)" }}
        ...
        <div className="relative mb-8 flex items-center justify-center">
          <motion.div
            ...
            style={{
              width: 180,
              height: 180,
              background: "radial-gradient(circle, rgba(215,38,61,0.55), rgba(215,38,61,0.3) 55%, transparent 80%)",
              filter: "blur(36px)",
            }}
          ...
          <Image
            ...
            style={{
              filter: "drop-shadow(0 0 32px rgba(215,38,61,0.75)) drop-shadow(0 8px 24px rgba(0,0,0,0.55))",
            }}
          />
        </div>

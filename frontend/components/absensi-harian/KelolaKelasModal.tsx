          ...
          {editing ? (
            <div className="space-y-3 rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700/50 dark:bg-slate-800/40">
              <div>
                ...
                <input value={nama} onChange={(e) => setNama(e.target.value)} placeholder="Contoh: XII AKL 1"
                  className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary dark:border-slate-600 dark:bg-slate-900 dark:text-slate-200" />
              </div>
              <div>
              ...
              <div className="flex justify-end gap-2 pt-1">
                ...
                <button onClick={save} disabled={saving}
                  className="rounded-xl bg-primary px-4 py-1.5 text-xs font-bold text-white disabled:opacity-50">
            ...
            <button onClick={startCreate}
              className="mb-3 flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 py-2.5 text-xs font-bold text-slate-500 hover:border-primary hover:text-primary dark:border-slate-600">

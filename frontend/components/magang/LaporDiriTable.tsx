                ...
                {rows.map((r) => {
                  ...
                  return (
                    <tr key={r.penempatanId} className="border-b border-slate-100 transition-colors last:border-0 hover:bg-slate-50 dark:border-slate-700/40 dark:hover:bg-slate-700/20">
                      ...
                      <td className="whitespace-nowrap px-4 py-3">
                        {r.sudahLapor ? (
                          <span className="inline-flex items-center gap-1 rounded-lg px-2.5 py-1 text-[11px] font-semibold" style={{ backgroundColor: "#ECFCCB", color: "#4D7C0F" }}>
                ...
                return (
                  <div key={r.penempatanId} className="flex flex-col gap-2.5 p-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      {r.sudahLapor ? (
                        <span className="inline-flex shrink-0 items-center gap-1 rounded-lg px-2 py-1 text-[10px] font-semibold" style={{ backgroundColor: "#ECFCCB", color: "#4D7C0F" }}>

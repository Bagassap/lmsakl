...
const INPUT_CLS = "w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#D7263D]/30 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-200";
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-end justify-center p-0 sm:items-center sm:p-4">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.94, y: 24 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.94, y: 24 }}
        ...
        <div className="relative flex shrink-0 items-center gap-3 overflow-hidden bg-[#D7263D] px-6 py-5">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-5">
          {editing ? (
            <div className="space-y-3 rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700/50 dark:bg-slate-800/40">
              ...
              <div className="flex justify-end gap-2 pt-1">
                ...
                <button onClick={save} disabled={saving}
                  className="rounded-xl bg-[#D7263D] px-4 py-1.5 text-xs font-bold text-white disabled:opacity-50">
            ...
            <button onClick={startCreate}
              className="mb-3 flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-slate-300 py-2.5 text-xs font-bold text-slate-500 hover:border-[#D7263D]/40 hover:text-[#D7263D] dark:border-slate-600">

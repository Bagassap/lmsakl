...
// #D97706 = referensi Nasabah's "primary" (dipakai literal di dot-grid pattern
// & JENIS_COLOR.siswa di file referensi), sengaja di-hardcode di sini alih-alih
// pakai token --color-primary bawaan (#D97706) karena token itu dipakai luas
        ...
        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
          <div className="relative shrink-0 sm:w-44">
            ...
            <select
              ...
              className="h-10.5 w-full appearance-none rounded-lg border border-slate-200 bg-white pl-9 pr-8 text-sm font-semibold text-slate-700 transition-all focus:border-[#D97706] focus:outline-none focus:ring-2 focus:ring-[#D97706]/12 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200"
            >
          ...
          <div className="relative w-full sm:max-w-xs">
            ...
            <input
              ...
              className="h-10.5 w-full rounded-lg border border-slate-200 bg-white pl-10 pr-9 text-sm text-slate-700 placeholder:text-slate-400 transition-all focus:border-[#D97706] focus:outline-none focus:ring-2 focus:ring-[#D97706]/12 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:placeholder:text-slate-500"
            />
            <AnimatePresence>
              {search && (
                <motion.button

...
const ROLE_BADGE: Record<string, { label: string; cls: string; dot: string }> = {
  ADMIN: { label: "Admin",  cls: "bg-[#E8E7E4] text-[#3D3D3D] dark:bg-[#3D3D3D]/40 dark:text-[#B0B0B0]", dot: "#3D3D3D" },
  GURU:  { label: "Guru",   cls: "bg-[#FFE8DA] text-[#FF5B19] dark:bg-[#FF5B19]/30 dark:text-[#FFA372]",  dot: "#FF5B19" },
  SISWA: { label: "Siswa",  cls: "bg-[#E1EDEE] text-[#4F7377] dark:bg-[#4F7377]/30 dark:text-[#AECACD]", dot: "#4F7377" },
};
              ...
              >
                <div className="flex items-end gap-2 rounded-xl border border-[#4f7377]/25 bg-gradient-to-br from-blue-50 to-white p-3 dark:border-blue-700/30 dark:from-blue-900/10 dark:to-[#1c2434]">
                  ...
                  <button
                    ...
                    style={{ background: "linear-gradient(135deg, #161616 0%, #4f7377 50%, #4f7377 100%)" }}
                  >
  ...
  return (
    <div className="space-y-5">
      ...
      <div className={`relative overflow-hidden rounded-2xl border-2 bg-white transition-all duration-200 dark:bg-slate-800/50 ${
        focused
          ? "border-[#4f7377]/40 shadow-[0_0_0_4px_rgba(37,99,235,0.08)]"
        ...
        <div className={`absolute left-0 right-0 top-0 h-0.5 transition-opacity duration-200 ${focused ? "opacity-100" : "opacity-0"}`}
          style={{ background: "linear-gradient(90deg, #161616 0%, #4f7377 50%, #4f7377 100%)" }} />
